...
public class CustomerHomePenginapanAdapter extends RecyclerView.Adapter<CustomerHomePenginapanAdapter.MyHolder> {
    Context context;
    List<Penginapan> wisataList;

    public CustomerHomePenginapanAdapter(Context context, List<Penginapan> wisataList){
    ...
    public void onBindViewHolder(MyHolder holder, int pos){
        ...
        holder.gambar.setImageResource(Integer.parseInt(wisataList.get(pos).getFoto()));
