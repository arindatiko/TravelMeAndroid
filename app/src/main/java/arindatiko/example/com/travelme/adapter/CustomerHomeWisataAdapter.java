...
public class CustomerHomeWisataAdapter extends RecyclerView.Adapter<CustomerHomeWisataAdapter.MyHolder> {
   Context context;
   List<TempatWisata> wisataList;

   public CustomerHomeWisataAdapter(Context context, List<TempatWisata> wisataList){
